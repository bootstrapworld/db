...
function refreshDatePicker(dateFieldName, year, month, day)
{
	...
	html += "<a href='javascript: refreshDatePicker(\"" + dateFieldName + "\");'>this month</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	html += "<a href='javascript: updateDateField(\"" + dateFieldName + "\");'>close</a>";
	html += xTD + xTR;
...
function getFieldDate(dateString)
{
	...
	if(y < 1940) dateVal.setFullYear(y+100);
	return dateVal;
}
